...
public class NNTSService {
    ...
    public tech.pcloud.nnts.core.model.Service registreService(tech.pcloud.nnts.core.model.Service service, Channel channel) {
    ...
    public void beforeConnectProxy(long requestId, Channel requestChannel, Channel proxyChannel, Node client, tech.pcloud.nnts.core.model.Service service) {
